...
class UnorderedList:
    ...
    def insert(self, index, data):
        """
        Add new node at a specific index, raise exception if index
        doesnt excist
        """
    ...
    def set(self, index, data):
        """
        Replace value at a specific index, raise exception if
        index doesnt excist
        """
    ...
    def index_of(self, data):
        """
        Return the index of a specific value, if values doesnt
        excist raise exception
        """
    ...
    def remove(self, data):
        """
        Remove node matching a specific value, if values doesnt
        excist raise exception
        """
